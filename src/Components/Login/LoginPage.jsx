        ...
        <form className=" justify-center items-center flex flex-col ">
          ...
          <div className=" justify-center items-center flex flex-col relative top-[10rem] ">
            <input
              ...
              className=" w-[25rem] h-[3rem] bg-transparent border-gray-200/30 border-2 rounded-lg 
              outline-none  hover:border-gray-200/80  text-white pl-4 text-xl"
            />{" "}
            <br /> <br />
            <input
              type="password"
              ...
              className=" w-[25rem] h-[3rem] bg-transparent border-gray-200/30 border-2 rounded-lg 
              outline-none hover:border-gray-200/80 pl-4 text-xl "
            />
            <p className="text-white mt-6">
              Forget Password{" "}
              <a
                href="#"
                className=" underline hover:text-red-600/80 hover:font-semibold"
              >
                Click Here
              </a>
            </p>
